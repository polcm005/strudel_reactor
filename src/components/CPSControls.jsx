...
function CPSControls({ onChange, onClick, input }) {
    return (
        <>
            ...
            <span className="input-group-text" id="cpmControl"><b>Set CPS</b></span>
                <input type="text" className="form-control" placeholder="Enter CPS here..." value={input} aria-label="cps control form" aria-describedby="cpsControl" id="cps_input_field" onChange={onChange} />
